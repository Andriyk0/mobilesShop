...
import {
  getAccessories, getCheckout, getFavorite,
...
export const AccessoriesPage:React.FC = () => {
  ...
  const phones = useSelector(getAccessories);
  const [
  ...
  return (
    <div className="phones">
      <div className="phones__path_container">
        ...
        <p className="phones__path">Accessories</p>
      </div>
      <p className="phones__title">Accessories</p>
      ...
      {
        phones.length === 0 && (
          <p className="noProduct">No Accessories</p>
        )
      }
